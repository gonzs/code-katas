...
function contains(store, product) {
  ...
  const lookInto = (obj, value) => {
    Object.values(obj).forEach((o) => {
      if (typeof o === "object") lookInto(o, value);

      if (o === value) isContained = true;
    });
  };

  lookInto(store, product);
  return isContained;
}
...
const productos = ["camiseta", "gameboy"];

almacenes.forEach((almacen, index) =>
  console.log(contains(almacen, productos[index]))
);
