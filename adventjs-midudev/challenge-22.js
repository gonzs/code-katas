...
function countDecorations(bigTree) {
  ...
  const countDecorationsByLeaf = (leaf) => {
    if (leaf) {
      decorations += leaf.value;

      countDecorationsByLeaf(leaf.left);
      countDecorationsByLeaf(leaf.right);
    }
  };

  countDecorationsByLeaf(bigTree);
  return decorations;
}
